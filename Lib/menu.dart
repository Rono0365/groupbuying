...
class _RutimetableState extends State<Rutimetable> {
  ...
  Future getWeather() async {
    ...
    //http://192.168.100.74:8000/restaurant/ http://172.16.12.17:8000/
    print('rono' + token);
    ...
    http.Response responsev = await http.get(
        Uri.parse('http://192.168.100.74:8000/restaurant/' + widget.title),
        headers: headers);
...
*/
  ...
  Future addata(String otype, String zum, String otime, String oname) async {
    ...
    http.Response responsev =
        await http.post(Uri.parse('http://192.168.100.74:8000/order/'),
            headers: {
              'Content-Type': 'application/json; charset=UTF-8',
              'Authorization': 'Token $token',
            },
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: NetworkImage(
                                    sky['image_of_restaurant'].toString()),
                                fit: BoxFit.cover,
                              ),
                            ),
                                                                  ...
                                                                  subtitle: FloatingActionButton
                                                                      .extended(
                                                                          backgroundColor: Colors
                                                                              .teal,
                                                                          //icon: Icon(Icons.flatware_outlined),
                                                                          label: Text(widget.user.toString() == 'Menu'
                                                                              ? "Pay using other means i.e Cash"
                                                                              : "Continue"),
                                                                          onPressed:
                                                                              () {
                                                                            ...
                                                                            Navigator.push(context,
                                                                                MaterialPageRoute(builder: (context) => widget.user.toString() == 'Menu' ? screenxc2(title: "${selectedTime.hour}:${selectedTime.minute}") : screenxc()));
                                                                            //Navigator.pop(context);
                                                                            //Navigator.pop(context);
                                                                            cart.clear();
                                                                            setState(() {
